...
- **USB-C 槽**：14 × 30 mm 贯通 -Y 短边壁（外口 y −50 → 内口 y −48，穿壁 2 mm；槽体 z 0..29.7 全高贯通——blend 实测（旧文 8 mm 高为误——槽容插口 z7-13 与插头穿梭，30 高必需）；槽体向下延伸至 z −0.3 越过底壁外表面，避免布尔相切），直达 Marmota J1 插口端（主板座中心 y 34.19 → Blender −26.31；连接器端面偏 +0.46 → 插口端 −25.85，blend 实测）
