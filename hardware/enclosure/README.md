...
| 编码器 EC10E | 杆 Ø6 × 9 | 标准规格 | ⚠️ **杆高变体 8–10** | 延长套杆：杆高 9 套 3 mm（顶 26 插入盲孔 26–29）、10 套 2 mm（够）；**<9 时杆顶 <26 不进入盲孔——延长悬空不套杆、旋钮不转** | QA 0c 实测杆高 |
...
| `QA_first_build.md` | 3475 B | `58a3bd2ccc5c9a1e` |
...
| 0c | 编码器 EC10E 杆高 | 9（变体 8–10；<9 杆顶<26 不进入盲孔——延长悬空不套杆） | 延长盲孔加深/换长杆型号 |
...
| 3b | 编码器杆高（QA 0c） | 到货实测 | 9（≥9——顶 26 须进入盲孔 26–29） | 延长盲孔加深/换长杆型号 |
