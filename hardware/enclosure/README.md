...
| 用量 | **材料体积估算：底壳 ~82 cm³ / 顶盖 ~71 cm³ / 小件 9.3 cm³（实心）→ PLA 1.24 g/cm³：底壳 ~100 g / 顶盖 ~88 g / 小件 ~12 g / 合计 ~200 g**（壁 2.5 实心为主体；20% 填充仅影响壁内空腔，对薄壁壳影响 <5%；⚠️ 原『87.5/61.6/9.3 cm³ 实心体积 + 40 g』为包围体积 × 填充系数双重误算、低估约 5 倍——已修正；**精确用量以切片器估算为准**） |
...
| 摇杆杆 Ø10 vs 摇杆孔 21×21 | 5.5 | 摆动余量（帽盘 ≤Ø15 摆 10.9° 边缘余量 ≥0.67；Ø20 会穿出孔缘 1.78 不可用） | 大余量 ✓ |
