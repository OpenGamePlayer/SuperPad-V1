...
- [ ] 大帽盘升级路径（上限 Ø17）：帽盘摆后位移 = 0.982r+2.458（r 帽盘半径）——Ø17 需孔 22×22（半 11 ≥ 10.81 摆后，余 0.2；U2 孔右缘 45 vs S8 键帽孔左缘 45.6 间隙 0.6 不穿）；**Ø18+ 不可行——24×24 与 S8 孔 x 重叠 0.4 / 26×26 重叠 1.4（穿孔）——须先重排 S8（PCB 侧）再扩孔**
