...
├── stl/
│   ├── bottom.stl            # 底壳 STL (3108 三角面, 单连通水密开口壳, 88.3 cm³)
│   ├── top.stl               # 顶盖 STL (2128 三角面, 单连通水密, 64.1 cm³, 含坐腔筒 z2.5-32)
...
- **M3 螺丝柱 ×4**（±68,±38，z 2.5–29.2，法兰嵌入底壁）：顶盖 M3 沉孔螺钉紧固；柱内 **φ2.5 贯穿孔**（M3 塑料自攻底孔；孔底穿至 z −1.5，越过支脚底，避免布尔相切残边）
...
| 用量 | 底壳 88.3 cm³ / 顶盖 64.1 cm³ / 按压杆+滑块 3.5 cm³（实心体积；20% 填充实际约 底壳 22 g / 顶盖 16 g，PLA 1.24 g/cm³） |

## 关键设计验证

| 检查项 | 结果 |
|---|---|
| **STL 水密（边界边 = 0）** | ✅ **3/3 全水密**：**bottom 3108 / top 2128 / rods 424，边界边均 0 |
| **STL 连通（无漂浮件）** | ✅ bottom 单连通 1 件 / top 单连通 1 件 / rods 6 件（4 杆 + 2 滑块，符合设计） |
| **STL 体积断链** | ✅ bottom 88.3 cm³（开口壳，非实心 547）/ top 64.1（含坐腔筒）/ rods 3.5 —— 防"实心网格假单连通"暗病 |
