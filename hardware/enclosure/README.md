...
| **面板布局两两间距（18 凸出件 2D 包络——帽盘 2 + 旋钮 1 + 键帽 13 + 滑块帽 2；摇杆杆在孔内不凸出不计）** | ✅ 6 对 <3 mm：最紧 **S4/S5 键帽 vs 滑块帽 0.70**（S4=Keycap_1 (−49,−15.5) 对 L1 帽区左缘 x 距 0.70；S5 (49,5.5) 对 L2 帽区右缘 0.70——对称两对，blend 实测帽区包络）（静态间隙无运动碰撞，公差余 0.3）、旋钮-键帽 0.90（约束 Ø16 已定）、S2/S7 1.40、U2 帽盘-S8 2.00；其余 2 对 2.0–3.0 之间（非最紧，均安全未逐列） |
