...
│   └── rods.stl              # 按压杆×4 + 肩键滑块×2 + 键帽×13 + 编码器延长×1 (720 三角面, 8.0 cm³) - 独立小件
...
| 检查项 | 结果 |
|---|---|
| **STL 水密（边界边 = 0）** | ✅ **3/3 全水密**：**bottom 3108 / top 2128 / rods 720，边界边均 0 |
| **STL 连通（无漂浮件）** | ✅ bottom 单连通 1 件 / top 单连通 1 件 / rods 20 件（4 杆 + 2 滑块 + 13 键帽 + 1 编码器延长，符合设计） |
| **STL 体积断链** | ✅ bottom 88.2 cm³（开口壳，非实心 547）/ top 61.7（含坐腔筒）/ rods 8.0（20 件含键帽延长） —— 防"实心网格假单连通"暗病 |
