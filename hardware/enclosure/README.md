...
> **交付版本 v1.0**（几何冻结，交付日期 2026-09-08 持续维护——最新 commit 日期为准）：bottom = back_v12（3044 三角 / 87.5 cm³）、top = front_v8（2148 三角 / 61.6 cm³）、rods = v6d（676 三角 / 9.3 cm³，20 件；v6d = v6 斜楔修订版——滑块帽 13.6×11.6/沉槽 14.2×12.0 收窄帽晃）。验证套件 `verify/enclosure_verify.py` v12 一键回归（水密/拓扑/装配/运动学/法线字段）。
...
| 螺丝锁不紧 / 滑牙 | 自攻咬合不足 / 孔偏大 | 柱孔微扩 0.1–0.2 / M3 热熔铜螺母 |
...
| 螺丝柱孔滑牙 | 自攻过紧 / 层间弱 | 柱孔微扩 0.1–0.2 / M3 热熔铜螺母（见 BOM 备件） |
