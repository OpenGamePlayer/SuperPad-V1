...
| PlatformIO | `platformio_ide/RP2040/` | PlatformIO + maxgerhardt raspberrypi (picosdk) | ⚠️ 官方 CMake 路线已验证可编译；`pio run` 平台支持 pending |
...
- [ ] PlatformIO：`pio run` 全流程验收（fork 平台下载中/文件组织待定）
